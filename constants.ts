...
export const INITIAL_MENU_ORDER: MenuItem[] = [
    ...
    { id: 'analyt', label: 'Análise Geral', iconName: 'ChartPieIcon', view: 'analytics', sequence: 5, visible: true },
    { id: 'chk', label: 'Checklist Obra', iconName: 'CheckCircleIcon', view: 'construction-checklist', sequence: 6, visible: true },
    { id: 'note', label: 'Notas & Visitas', iconName: 'NotepadIcon', view: 'notes', sequence: 7, visible: true },
    { id: 'part', label: 'Parceiros', iconName: 'UsersIcon', view: 'partners', sequence: 8, visible: true },
    { id: 'client', label: 'Área Cliente', iconName: 'UsersIcon', view: 'client-area', sequence: 9, visible: true },
    { id: 'price', label: 'Precificação', iconName: 'MoneyBagIcon', view: 'pricing', sequence: 10, visible: true },
    { id: 'prog', label: 'Andamento', iconName: 'TrendingUpIcon', view: 'progress', sequence: 11, visible: true },
    { id: 'fin', label: 'Financeiro', iconName: 'ReceiptIcon', view: 'projections', sequence: 12, visible: true },
    { id: 'exp', label: 'Despesas', iconName: 'CreditCardIcon', view: 'expenses', sequence: 13, visible: true },
    { id: 'set', label: 'Ajustes', iconName: 'CogIcon', view: 'settings', sequence: 14, visible: true },
];
